        ...
        contents: [
          {
            id: 1,
            name: '1.1 数据库系统概述(1)',
            url: 'http://chinadb.ruc.edu.cn/Public/video/course/1.1(1).mp4'
          },
          {
            id: 2,
            name: '1.1 数据库系统概述(2)',
            url: 'http://chinadb.ruc.edu.cn/Public/video/course/1.1(2).mp4'
          },
          {
            id: 3,
            name: '1.2 数据模型',
            url: 'http://chinadb.ruc.edu.cn/Public/video/course/1.2.mp4'
          },
          {
            id: 4,
            name: '1.3 数据库系统结构',
            url: 'http://chinadb.ruc.edu.cn/Public/video/course/1.3.mp4'
          },
          {
            id: 5,
            name: '1.4 数据库系统的组成',
            url: 'http://chinadb.ruc.edu.cn/Public/video/course/1.4.mp4'
          }
        ]
      },
      {
